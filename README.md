...
Add the Object Action to your desired Liferay Object (as part of a Post Add, Delete, or as a standalone action).
After configuring it, perform the corresponding operation on the Object, and observe the response in the .NET console window (dotnet run).
